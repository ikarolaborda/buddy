...
return [
    ...
    */
    ...
    /*
     * Wall-clock ceiling per request. Inline refine/evaluate (?sync=1)
     * can hold a worker up to the 120s provider timeout; 150 preserves
     * parity with the fpm image's fastcgi_read_timeout.
     */
