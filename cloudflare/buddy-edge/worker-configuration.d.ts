/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=preview --strict-vars=false` (hash: 8f0442b809686f13a2753aa125b20ce7)
// Runtime types generated with workerd@1.20260911.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	BUDDY_READ_CACHE: KVNamespace;
	BUDDY_ARTIFACTS: R2Bucket;
	BUDDY_EVENTS: Queue;
	BUDDY_ARTIFACT_EVENTS: Queue;
	BROWSER: BrowserRun;
	ASSETS: Fetcher;
	AZURE_API_BASE: string;
	ALLOWED_ORIGIN: string;
	SUPERVISION_ENABLED: string;
	AUTO_RECOVERY_ENABLED: string;
	READ_CACHE_ENABLED: string;
	BROWSER_DIAGNOSTICS_ENABLED: string;
	DAILY_BUDGET_EVENTS: string;
	DAILY_BUDGET_CALLBACKS: string;
	DAILY_BUDGET_WORKFLOWS: string;
	DAILY_BUDGET_CAPTURES: string;
	MAX_ACTIVE_SOCKETS_PER_TASK: string;
	BUDDY_TASK_PROGRESS: DurableObjectNamespace<import("./src/index").BuddyTaskProgress>;
	BUDDY_EDGE_BUDGET: DurableObjectNamespace<import("./src/index").BuddyEdgeBudget>;
	BUDDY_TASK_SUPERVISOR: Workflow<Parameters<import("./src/index").BuddyTaskSupervisor['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BuddyTaskProgress" | "BuddyEdgeBudget";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AZURE_API_BASE" | "ALLOWED_ORIGIN" | "SUPERVISION_ENABLED" | "AUTO_RECOVERY_ENABLED" | "READ_CACHE_ENABLED" | "BROWSER_DIAGNOSTICS_ENABLED" | "DAILY_BUDGET_EVENTS" | "DAILY_BUDGET_CALLBACKS" | "DAILY_BUDGET_WORKFLOWS" | "DAILY_BUDGET_CAPTURES" | "MAX_ACTIVE_SOCKETS_PER_TASK">> {}
}
